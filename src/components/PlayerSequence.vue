<template>
  <div class="player-sequence flex flex-wrap justify-center gap-2 mb-4" role="list" aria-label="Urutan angka yang Anda pilih">
    <div
      v-for="item in sequence"
      :key="item.name"
      :class="[
        'w-12 h-12 flex items-center justify-center rounded-full text-white font-bold cursor-pointer transition-all duration-200 transform',
    ...
    <div v-if="sequence.length === 0" class="text-gray-500 italic flex items-center justify-center w-full" role="status" aria-live="polite">
